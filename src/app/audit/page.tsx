        ...
        <section ref={resultsRef} className="pb-24">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex items-center gap-3 mb-8">
              <div className="flex gap-1 flex-1 bg-navy-900 border border-navy-800 rounded-xl p-1.5 overflow-x-auto">
                {tabs.map((tab) => (
              ...
              <button
                onClick={() => generateAuditPdf(report as any)}
                className="shrink-0 flex items-center gap-2 px-4 py-2.5 bg-navy-900 border border-navy-800 rounded-xl text-sm font-display font-medium text-navy-300 hover:text-white hover:border-navy-700 transition-all"
              >
